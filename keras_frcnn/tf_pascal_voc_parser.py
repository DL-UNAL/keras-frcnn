	...
	for annot in annots:
		try:
			...
			if len(element_objs) > 0:
				annotation_data = {'filepath': os.path.join(imgs_path, element_path), 'width': element_width,
								   'height': element_height, 'bboxes': []}

				if element_path in trainval_files:
					annotation_data['imageset'] = 'trainval'
				elif element_path in test_files:
